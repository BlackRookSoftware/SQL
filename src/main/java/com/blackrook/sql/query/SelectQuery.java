 ...
 ******************************************************************************/
package com.blackrook.sql.query;
...
public final class SelectQuery
{
	...
	public SelectQuery addColumns(ColumnDescriptor ... columns)
	{
		...
		if (columnList == null) 
			columnList = new ArrayList<ColumnDescriptor>(columns.length);
	...
	public SelectQuery from(TableDescriptor ... tables)
	{
		...
		if (fromTables == null) 
			fromTables = new ArrayList<TableDescriptor>(tables.length);
	...
	public SelectQuery where(CriteriaClause ... criteria)
	{
		...
		if (whereClauses == null) 
			whereClauses = new ArrayList<CriteriaClause>(criteria.length);
	...
	public SelectQuery groupBy(GroupDescriptor ... groups)
	{
		...
		if (groupClauses == null) 
			groupClauses = new ArrayList<GroupDescriptor>(groups.length);
	...
	public SelectQuery having(CriteriaClause ... criteria)
	{
		...
		if (havingClauses == null) 
			havingClauses = new ArrayList<CriteriaClause>(criteria.length);
		for (CriteriaClause t : criteria)
			havingClauses.add(t);
		return this;
	}
	...
	public SelectQuery orderBy(OrderClause ... ordering)
	{
		...
		if (orderClauses == null) 
			orderClauses = new ArrayList<OrderClause>(ordering.length);
	...
	public SelectQuery union(SelectQuery query)
	{
		if (unionClauses == null) 
			unionClauses = new ArrayList<UnionClause>(2);
